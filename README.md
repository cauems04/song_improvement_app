...
As a solution, I've thought of an app that must have the following core features:
...
Use case diagram - It was important to have a better understaning on the app's features and look at it on ythe big picture.

Class diagram - Used it to understand the data I'd have to use on the app, and specially what data I'd have to store in the database.

(Diagrams' images will be inserted here very soon).
